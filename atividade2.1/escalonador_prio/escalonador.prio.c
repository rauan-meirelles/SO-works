...
void estatisticas (BCP *processo, int imprime_sumario)
{
        ...
        if(!imprime_sumario)
        {
                ...
                if(processo->num_fila1 == 0){
                        printf("Fui escalonado da maneira FIFO\n");
                        printf ("Passagens pela fila 2:                  %d\n", processo->num_fila2);
                        
                }else{
                        printf("Fui escalonado da maneira RR\n");
        ...
        {
                printf ("\nSumario: \n\n");
                printf("Fui escalonado da maneira FIFO           %d\n", processo_fifo);
                printf("Fui escalonado da maneira RR           %d\n", processo_rr);
...
void escalona_FCFS(BCP *fila2,BCP *bloqueados){
        /**
...
void escalona_RR(BCP *fila1,BCP *bloqueados){
        /**
         * Ponteiro que vai apontar para o processo que estar� em execu��o.
         *
         * � importante observar que este ponteiro simula o processo que est�
...
{
        escalona_RR(fila1, bloqueados);
        escalona_FCFS(fila2, bloqueados);
...
int main(int argc, char **argv)
{
        ...
        for (i = 0; i < n; i++)
        {
                ...
                valor_prioridade = (double) random() / (double) RAND_MAX;

                
                if( valor_prioridade <= 0.8){
