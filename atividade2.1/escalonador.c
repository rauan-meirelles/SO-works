...
void escalona (BCP *fila1, BCP *fila2, BCP *bloqueados)
{
        ...
        while (executa)
        {
                ...
                while (fila2 != NULL && fila1 == NULL)
                {
                        ...
                        // Verifica se o processo utilizar� mais tempo do que
                        ...
                        {       
                                ...
                                // Modifica��o 6: Somente executa o tempo do
                                // QUANTUM, n�o mais o excesso gerado.
                                for (i=0; i < (int) QUANTUM; i++);
                                
                                // Modifica��o 7: Verifica se o processo
                                ...
                                else
                                {
                                    ...
                                    //
                                    // Ponto a analisar:
                                    // 1 - Se o processo j� est� na fila2, ele
                                    // retornar� para o final desta mesma fila.
                                    processo->num_fila2++;
                                    gettimeofday(&(processo -> inicio), NULL);
                                    fila2 = anexa_fila(processo, fila2);
                                }
